...
INPUT_FILE_PATH = '/path/to/your/video.mkv'
...
# Sprite Creation
puts "Creating sprites for encoding with id #{enc.id} and stream with id #{stream_720_2400.id}"
sprite = Bitmovin::Encoding::Encodings::Sprite.new(enc.id,
                                                   stream_720_2400.id,
                                                   {
                                                       name: 'MySpriteName',
                                                       ...
                                                       outputs: [{
                                                                     ...
                                                                     output_path: File.join(OUTPUT_PATH, 'sprites')
                                                                 }]
                                                   }).save!
