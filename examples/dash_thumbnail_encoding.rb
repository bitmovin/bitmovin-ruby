...
HTTP_INPUT_HOST = 'your.input.host'
INPUT_FILE_PATH = '/path/to/your/input/video.mkv'

OUTPUT_AWS_ACCESS_KEY = '<YOUR AWS S3 ACCESS KEY>'
OUTPUT_AWS_SECRET_KEY = '<YOUR AWS S3 SECRET KEY>'

BUCKET_NAME = '<YOUR BUCKET NAME>'
OUTPUT_PATH = "path/to/your/output/#{Time.now.strftime('%v-%H-%M')}/"
MPD_NAME = 'manifest_name.mpd'
...
# Thumbnail Creation
puts "Creating thumbnails for encoding with id #{enc.id} and stream with id #{stream_720_2400.id}"
thumbnail = Bitmovin::Encoding::Encodings::Thumbnail.new(enc.id,
                                                         stream_720_2400.id,
                                                         {
                                                             ...
                                                             outputs: [{
                                                                           ...
                                                                           output_path: File.join(OUTPUT_PATH, 'thumbnails')
                                                                       }]
                                                         }).save!
