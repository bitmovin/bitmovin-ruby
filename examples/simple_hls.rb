...
ts_muxing_720_700 = enc.muxings.ts.build(name: 'H264 1280x720 700kb/s', segment_length: 4)
ts_muxing_720_700.build_output({
  output_id: s3_output.id,
  output_path: File.join(OUTPUT_PATH, "video/720_700")
})
ts_muxing_720_700.streams << stream_720_700.id
ts_muxing_720_700.save!

ts_muxing_720_1500 = enc.muxings.ts.build(name: 'H264 1280x720 1500kb/s', segment_length: 4)
ts_muxing_720_1500.build_output({
  output_id: s3_output.id,
  output_path: File.join(OUTPUT_PATH, "video/720_1500")
})
ts_muxing_720_1500.streams << stream_720_1500.id
ts_muxing_720_1500.save!

ts_muxing_720_2400 = enc.muxings.ts.build(name: 'H264 1280x720 2400kb/s', segment_length: 4)
ts_muxing_720_2400.build_output({
  output_id: s3_output.id,
  output_path: File.join(OUTPUT_PATH, "video/720_2400")
})
ts_muxing_720_2400.streams << stream_720_2400.id
ts_muxing_720_2400.save!
...
# FIXME, change method name to build_audio_media
audio_media = manifest.build_audio_medium({
...
variant_stream_720_700 = manifest.build_variant_stream({
  audio: 'audio_group',
  closed_captions: 'NONE',
  segment_path: 'video/720_700',
  uri: 'videomedia700.m3u8',
  encoding_id: enc.id,
  stream_id: stream_720_700.id,
  muxing_id: ts_muxing_720_700.id
})
variant_stream_720_700.save!

variant_stream_720_1500 = manifest.build_variant_stream({
  audio: 'audio_group',
  closed_captions: 'NONE',
  segment_path: 'video/720_1500',
  uri: 'videomedia1500.m3u8',
  encoding_id: enc.id,
  stream_id: stream_720_1500.id,
  muxing_id: ts_muxing_720_1500.id
})
variant_stream_720_1500.save!

variant_stream_720_2400 = manifest.build_variant_stream({
  audio: 'audio_group',
  closed_captions: 'NONE',
  segment_path: 'video/720_2400',
  uri: 'videomedia2400.m3u8',
  encoding_id: enc.id,
  stream_id: stream_720_2400.id,
  muxing_id: ts_muxing_720_2400.id
})
variant_stream_720_2400.save!
