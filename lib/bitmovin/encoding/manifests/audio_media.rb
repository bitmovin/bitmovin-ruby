module Bitmovin::Encoding::Manifests
    class AudioMedia < Bitmovin::Resource
      def initialize(manifest_id, hash = {})
        path = File.join("/v1/encoding/manifests/hls/", manifest_id, "media/audio")
      ...
      attr_accessor :group_id, :language, :assoc_language, :name, :is_default
